# RB-ICD for Dynamic MRI Sampling
...
## Planned contents
- RB-ICD mask optimization code
- Reconstruction pipelines used in the experiments
- Scripts to reproduce figures and quantitative results
